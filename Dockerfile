...
RUN apt-get install git lighttpd php7.0-cgi hostapd dnsmasq vnstat
...
RUN iptables -t nat -A POSTROUTING -j MASQUERADE #RASPAP 
RUN iptables -t nat -A POSTROUTING -s 192.168.50.0/24 ! -d 192.168.50.0/24 -j MASQUERADE #RASPAP
